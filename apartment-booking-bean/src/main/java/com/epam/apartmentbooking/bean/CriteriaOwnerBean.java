 ...
 */
public class CriteriaOwnerBean implements Serializable {
    ...
    public CriteriaOwnerBean() {
        titlePiece = "";
        addressPiece = "";
    }

    public CriteriaOwnerBean(String titlePiece, String addressPiece) {
    ...
    public boolean equals(Object o) {
        ...
        CriteriaOwnerBean that = (CriteriaOwnerBean) o;
