 ...
 */
public class CriteriaPriceBean implements Serializable {
    ...
    public CriteriaPriceBean() {
        this.dailyMin = BigDecimal.ZERO;
        this.dailyMax = BigDecimal.ZERO;
        this.weeklyDiscountMax = 0;
        this.weeklyDiscountMin = 0;
        this.monthlyDiscountMax = 0;
        this.monthlyDiscountMin = 0;
    }

    public CriteriaPriceBean(BigDecimal dailyMin, BigDecimal dailyMax, double weeklyDiscountMin, double weeklyDiscountMax, double monthlyDiscountMin, double monthlyDiscountMax) {
    ...
    public boolean equals(Object o) {
        ...
        CriteriaPriceBean that = (CriteriaPriceBean) o;
